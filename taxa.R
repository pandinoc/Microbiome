...
metadata<-read_q2metadata("MetadataS3.txt")
str(metadata)
colnames(metadata)[2] = "treatment"
levels(metadata$treatment)
metadata$treatment.ord = factor(metadata$treatment, c("WB", "HMP", "ChIn", "RMD", "donor", "blank"))
...
physeq <- qza_to_phyloseq(
  ...
  tree="rooted-treeS.qza",
  taxonomy = "taxonomyS.qza",
  metadata = "MetadataS3.txt"
)
...
for(ml in my_level){
  ...
  physeq_meta_filtered$treatment.ord = factor(physeq_meta_filtered$treatment, c("WB", "HMP", "ChIn", "RMD", "donor", "blank"))
...
alpha = 0.05
#my_contrast = c("treatment", "donor", "WB") 
#my_contrast = c("treatment", "donor", "RMD") 
#my_contrast = c("treatment", "donor", "ChIn") 
#my_contrast = c("treatment", "donor", "HMP") 
#my_contrast = c("treatment", "donor", "blank") 
#my_contrast = c("treatment", "WB", "RMD") 
#my_contrast = c("treatment", "WB", "ChIn") 
#my_contrast = c("treatment", "WB", "HMP") 
#my_contrast = c("treatment", "WB", "blank") 
#my_contrast = c("treatment", "RMD", "ChIn") 
#my_contrast = c("treatment", "RMD", "HMP") 
#my_contrast = c("treatment", "RMD", "blank") 
#my_contrast = c("treatment", "ChIn", "HMP") 
#my_contrast = c("treatment", "ChIn", "blank") 
my_contrast = c("treatment", "trt", "donor") 
...
ggsave(paste0("output/3DESeq2-", my_contrast[2], "-", my_contrast[3], ".png"), DESeq_fig, height = 3, width = 10)
